                    ...
                    clientDL.on('close', function (c2) {
                        ...
                        javaDL.on('close', function (c) {
                            ...
                            /*if (!(fs.existsSync('data/assets/indexes/'+assetIndex+'.json'))){
                                assetDL = proc.spawn('aria2c', ['-x16', '-s16', '-m16', shit.assetIndex.url, '--out=assets/indexes/'+assetIndex+'.json'], { shell: true, detached: false })
                            }*/
